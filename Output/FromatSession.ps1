...
$serverinfo | Out-File C:\Scripts\Live360_2025\output\serverinfo.txt
...
function Get-DemoConsoleFormatting {
    Clear-Host
...
Get-DemoConsoleFormatting

# Demo 2: Exporting to CSV
function Get-DemoExportCSV {
    Clear-Host
...
function Get-DemoConvertToJSON {
    Clear-Host
...
Get-DemoConvertToJSON
# Demo 6: All-in-One Server Report with Multiple Outputs
function Get-DemoServerReportAllInOne {
    Clear-Host
...
function Start-FormattingDemo {
    do {
        ...
        switch ($choice) {
            '1' { Get-DemoConsoleFormatting; pause }
            '2' { Get-DemoExportCSV; pause }
            '3' { Get-DemoExportExcel; pause }
            '4' { Get-DemoHTMLReport; pause }
            '5' { Get-DemoConvertToJSON; pause }
            '6' { Get-DemoServerReportAllInOne; pause }
            'Q' { return }
            'q' { return }
